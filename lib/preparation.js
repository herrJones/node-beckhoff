...
function prepareAddPlcNotification(options, settings) {
  ...
  msgData.writeUInt32LE(options.request.idxGroup,   0);
  msgData.writeUInt32LE(options.request.idxOffset,  4);
  msgData.writeUInt32LE(options.request.size,       8);
  msgData.writeUInt32LE(options.request.mode,      12);
  msgData.writeUInt32LE(options.request.delay,     16);
  msgData.writeUInt32LE(options.request.cycle,     20);
...
function prepareDelPlcNotification(options, settings) {
  ...
  msgData.writeUInt32LE(options.request.handle, 0);
