  ...
  async sendBuffer (txdata, kind) {
    ...
    return new Promise((resolve, reject) => {
      ...
      function checkRxData(rxlen) {
        ...
        if (settings.develop.debug) {
          console.log('BKHF RX  : ' + rxdata.toString('hex') + '\n');
        }
...
async function getPlcInfo(callback) {
  ...
  try {
    ...
    rxInfo = after.analyzePlcInfo(data.slice(6), settings);
  }
  catch (exc) {
    console.log(exc);
  }
...
async function getPlcState(callback) {
  ...
  try {
    ...
    rxInfo = after.analyzePlcState(data.slice(6), settings);
  }
  catch (exc) {
...
async function getPlcSymbols(callback) {
  ...
  try {
    ...
    rxInfo = after.analyzePlcRead(data.slice(6), null, settings);
    ...
    rxInfo = after.analyzePlcSymbols(data.slice(6), symbols, settings);
...
function readPlcSymbolHandle (symbols, options, txData, plc) {
  ...
  return new Promise(async (resolve, reject) => {
    try {
      ...
      rxInfo = after.analyzePlcReadWrite(data.slice(6), settings);
      let offset = 0;
...
async function readPlcData(symData, callback) {
  ...
  try {
    ...
    rxInfo = after.analyzePlcRead(data.slice(6), options.request, settings);
  }
  catch (exc) {
    console.log(exc);
  }
...
async function writePlcData(symData, callback) {
  ...
  try {
    ...
    rxInfo = after.analyzePlcWrite(data.slice(6), options.request, settings);
  }
  catch (exc) {
    console.log(exc);
  }
