...
class BeckhoffClient extends events {
  ...
  create() {
    ...
    before.debugVerbose.enabled = this._settings.develop.verbose;
    after.debugVerbose.enabled  = this._settings.develop.verbose;
  ...
  create_database () {
    this._db.parallelize(() => {
      ...
      // [
      //  {"size":1,"alignSize":1,"adsType":"BYTE","flags":["In"],"reserved":0,"guid":"95190718000000000000000000000001","lenIsParm":0,"name":"value","kind":"BYTE","comment":""},
      //  {"size":4,"alignSize":4,"adsType":"UDINT","flags":["Out"],"reserved":0,"guid":"95190718000000000000000000000008","lenIsParm":0,"name":"error","kind":"UDINT","comment":""}
      // ]
      ...
      //  {"size":1,"alignSize":1,"adsType":"SINT","flags":["Out"],"reserved":0,"guid":"95190718000000000000000000000003","lenIsParm":0,"name":"old_value","kind":"SINT","comment":""},
      //  {"size":4,"alignSize":4,"adsType":"UDINT","flags":["Out"],"reserved":0,"guid":"95190718000000000000000000000008","lenIsParm":0,"name":"error","kind":"UDINT","comment":""}
      // ]
      this._db.run(`
    ...
    return new Promise((resolve, reject) => {
      this._db.get(`select ? as name, 
        ...
        if (row.num > 0) {
          ...
          this._db.run(`insert into symbols (handle, name) 
