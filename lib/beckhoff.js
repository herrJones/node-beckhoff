              ...
              this._db
                ...
                .parallelize(() => {
                  datatypes.forEach(element => {
                    ...
                    this.db.run(insStmt, [element.version, element.size, element.offset, element.datatype, 
                      ...
                      if (err) {
                        ...
                        element.rpccalls.forEach(rpcCall => {
                          this._db.run(rpcStmt, [rpcCall.version, rpcCall.vTableIdx, rpcCall.retSize,
              ...
              this._db
                ...
                .parallelize(() => {
                  symbols.forEach(element => {
                    ...
                    this._db.run(insStmt, [element.group, element.offset, element.size, 
