...
function analyzePlcSymbols(data) {
  ...
  function analyzeSymbol(pos, expLen) {
    ...
    symbol.adstype = config.getNameFromValue(config.ADS_DATA_TYPES, symbol.adstype);
...
function analyzePlcDataTypes(data) {
  ...
  function analyzeRpcParameter(pos) {
    ...
    parameter.adsType = config.getNameFromValue(config.ADS_DATA_TYPES, parameter.adsType);
  ...
  function analyzeRpcMethod(pos) {
    ...
    method.retAdsType = config.getNameFromValue(config.ADS_DATA_TYPES, method.retAdsType);
    method.flags      = config.getNameArrayFromValue(config.ADS_DATA_TYPE_FLAGS, method.flags);
  ...
  function analyzeDataType(pos) {
    ...
    curType.datatype = config.getNameFromValue(config.ADS_DATA_TYPES, curType.datatype);
    curType.flags    = config.getNameArrayFromValue(config.ADS_DATA_TYPE_FLAGS, curType.flags);
