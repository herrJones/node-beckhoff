...
function analyzeCommandNotification(data) {
  // NOTIFY COMPLETE: 00003e000000 0a51013f01018980 052a814701015303 0800 0400 1e000000 00000000 00000000 1a000000 01000000 a04a9fb434cdd601 010000004a010000020000000500
  // NOTIFY PAYLOAD: len      stamps   timestamp        samples  handle   size     data
  //                 1a000000 01000000 a04a9fb434cdd601 01000000 4a010000 02000000 0500
  //                 0        4        8                16       20       24       28                              
  //console.log('NOTIFY PAYLOAD: ' + data.toString('hex'));
