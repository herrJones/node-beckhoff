...
function analyzeHeader(data) {
  ...
  //  000038000000 0a51013f0101 8980 052a81470101 53030100 05001800000000000000010000000000000003017805506c6333302041707000000000000000
  //  000038000000 0a51013f0101 8980 052a81470101 53030100 0500180000000000
  ...
  //if (result.error > 0) {
  //  console.log('header = ' + data.toString('hex'));
  //  result.error = data.readUInt32LE(24).toString() + ' - ' + getValueFromName(config.ERRORS, data.readUInt32(24));
  //} 
  //}
 ...
 * @param {object} settings 
 */
function analyzePlcSymbols(data, db) {
  //const header = data.slice(0,32);
  //const message = data.slice(32);
